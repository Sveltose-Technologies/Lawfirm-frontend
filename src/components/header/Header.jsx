...
//   // --- 1. SETTINGS: Yahan se Button ka Size aur Color control karein ---
//   const buttonSettings = {
//     bgColor: '#de9f577e',      // Button ka rang (Red)
//     textColor: '#ffffff',    // Text ka rang (White)
...
//     setMobileMenu(prev => !prev ? 1 : false); 
//   };
...
//     return childPaths.some(path => router.pathname === path) ? 'active drop-down' : 'drop-down';
//   };

//   // --- Styles Objects (Next.js specific styling approach) ---
//   const desktopStyle = {
...
//   const mobileStyle = {
//     backgroundColor: buttonSettings.bgColor,
//     width: buttonSettings.mobileWidth,
//     height: buttonSettings.mobileHeight,
//     display: 'flex',
//     alignItems: 'center',
//     justifyContent: 'center',
//     borderRadius: '5px',
...
//                   alt="image" 
//                   src="assets/images/VTU9T9WZ-logo.png" 
//                   style={{ maxWidth: '120px', maxHeight: '35px', objectFit: 'contain' }} 
//                 />
//               </a>
//             </Link>
...
//             <a href="#" className={isParentActive(['/our-firm', '/firm-overview'])}>About Us</a>
//             <i className="bi bi-chevron-down dropdown-icon" />
//             <ul className="sub-menu">
//               <li><Link href="/our-firm"><a>Our Firm</a></Link></li>
//               <li><Link href="/firm-overview"><a>Firm Overview</a></Link></li>
//             </ul>
//           </li>

//           <li className="menu-item-has-children">
//             <a href="/attorneys" className={isParentActive(['/professionals', '/promoters'])}>Attorneys</a>
//           </li>

//            <li><Link href="/practice-areas"><a className={isActive('/practice-areas')}>Practice Areas</a></Link></li>


// {/* news */}
//           <li className="menu-item-has-children">
//             <Link href="#" className={isParentActive(['/publications', '/press-release', '/blog'])}>News</Link> 
//           </li>
          
            
//             <li className="menu-item-has-children">
//             <a href="#" className={isParentActive(['/professionals', '/promoters'])}>Blog</a>
//           </li>

//           {/* /events */}
//           <li><Link href="#"><a className={isActive('/events')}>Events</a></Link></li>
//           {/* /careers */}
//           <li><Link href=""><a className={isActive('/careers')}>Careers</a></Link></li>

//           {/* /locations */}
//           <li><Link href=""><a className={isActive('/locations')}>Locations</a></Link></li>
//           <li><Link href="/contact"><a className={isActive('/contact')}>Contact</a></Link></li>
//         </ul>

//         {/* --- MOBILE BUTTON (Next.js Link Implementation) --- */}
//         <div className="d-xl-none d-block">
//           <div className="eg-btn btn--primary btn--lg d-xl-none d-flex" style={mobileStyle}>
//             <Link href="/login-signup">
//               <a style={{ color: buttonSettings.textColor, textDecoration: 'none' }}>
...
//         {/* --- DESKTOP BUTTON (Next.js Link Implementation) --- */}
//         <div className="eg-btn btn--primary btn--lg d-xl-flex d-none" style={desktopStyle}>
//           <Link href="/login-signup">
//             <a style={{ color: buttonSettings.textColor, textDecoration: 'none' }}>
...
function Header() {
  ...
  // --- NEW STATE: Mobile Sub-menu Toggle karne ke liye ---
  ...
  // --- NEW FUNCTION: Mobile Sub-menu Toggle Logic ---
  const handleMobileSubMenu = (menuName) => {
    if (activeMobileSubMenu === menuName) {
      setActiveMobileSubMenu(null); 
      setActiveMobileSubMenu(menuName); 
    }
  };
      ...
      <div className={showMobileMenu === 1 ? "main-nav show-menu" :"main-nav"}>
        ...
        <ul className="menu-list">
          ...
          <li className="menu-item-has-children">
            ...
            <ul className="sub-menu" style={{ display: activeMobileSubMenu === 'about' ? 'block' : '' }}>
              <li><Link href="/our-firm"><a>Our Firm</a></Link></li>
              <li><Link href="/firm-overview"><a>Firm Overview</a></Link></li>
            </ul>
          </li>
...
{/* /practice-areas */}
           <li><Link href="#"><a className={isActive('/practice-area')}>Practice Areas</a></Link></li>

          {/* === NEWS === */}
         
            
          
         <li><Link href="#"><a className={isActive('/news')}>News</a></Link></li>

            
          {/* === BLOG === */}
            <li><Link href="#"><a className={isActive('/blog')}>Blog</a></Link></li>


          <li><Link href="#"><a className={isActive('')}>Events</a></Link></li>
          <li><Link href="#"><a className={isActive('')}>Location</a></Link></li>
          <li><Link href="#"><a className={isActive('')}>Contact</a></Link></li>
        </ul>
