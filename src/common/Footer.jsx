        ...
        <div className="footer-top">
          <div className="container-xl container-lg-fluid container">
            <div className="row gy-5">
              ...
              {/* =================================
                 Column 1: About & Global Presence (UPDATED WITH LINKS)
              ================================= */}
              <div className="col-lg-3 col-md-6">
                <div className="footer-about">
              ...
              <div className="col-lg-3 col-md-6 d-flex justify-content-lg-center">
                <div className="footer-item">
                  ...
                  <ul className="link-list">
                    ...
                    <li><Link href="/faq"><a className={`footer-link`}>FAQ</a></Link></li>
                    <li><Link href="/contact"><a className={`footer-link`}>Contact Us</a></Link></li>
                  </ul>
                </div>
              </div>
