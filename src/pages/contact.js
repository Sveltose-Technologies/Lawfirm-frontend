...
//   // --- THEME COLORS (Based on the reference style) ---
//   const theme = {
//     textDark: '#000000',
//     textGray: '#333333',
//     borderGray: '#cccccc',
//     accentGold: '#C5A059', // The GT-style gold/tan
//     btnBorder: '#003366', // Dark blue border for buttons
//     bgLight: '#fdfdfd',
//   };
...
//     if (!termsAccepted) {
//       alert("Please check the box to confirm you understand the disclaimer regarding confidential information.");
//       return;
//     }
...
//     <>
//       <Head>
//         <title>Contact Us | Greenberg Traurig Style</title>
//       </Head>

//       {/* ========================================================================== 
//           HERO BANNER (Matches the "Contact Us" cloud/building image vibe)
//       ========================================================================== */}
//       <div className="contact-hero position-relative d-flex align-items-center justify-content-center text-center">
//         {/* Background Image Placeholder - similar to the clouds/building */}
//         <div className="hero-bg" style={{
//             backgroundImage: `url('/assets/images/banner-img3.png')`, // Ensure you have a banner image here or change path
...
//         {/* Light overlay if needed, or just clear text */}
...
//             {/* Intro Text */}
//             <p className="mb-3 text-secondary" style={{ fontSize: '1.05rem', lineHeight: '1.6' }}>
//               Thank you for your interest in Greenberg Traurig. If you are interested in contacting one of our professionals, you may do so directly through the contact information contained on our team biographies.
//             </p>
//             <p className="mb-5 text-secondary" style={{ fontSize: '1.05rem', lineHeight: '1.6' }}>
//               If you are a member of the media with a general inquiry, please fill out the information below, or feel free to contact the individuals listed in the "Media Contacts" section to the right.
//             </p>
...
//               {/* Name Field */}
//               <div className="mb-4">
//                 <label className="fw-bold text-dark mb-1">Name*</label>
//                 <input 
//                   type="text" 
//                   name="name"
...
//                   rows="6"
//                   style={{ border: '1px solid #ccc', padding: '10px' }} // Textarea usually has a full border in this style
//                   required
...
//                   <strong>Note:</strong> Please do not send us any confidential or sensitive information without first speaking to one of our attorneys and receiving confirmation that the appropriate conflict checks have been cleared and the firm has determined it will accept the engagement. Any information or documents sent prior to your receipt of such confirmation cannot be treated as confidences, secrets or protected information of any nature.
//                 </label>
//               </div>
...
//           ========================== */}
//           <div className="col-lg-5 col-md-12 ps-lg-5 sidebar-separator">
...
//             <div>
//               <p className="mb-4" style={{ fontSize: '1rem', lineHeight: '1.6' }}>
//                 Click on the button below to learn more about careers at Greenberg Traurig.
//               </p>
//               <p className="mb-3" style={{ fontSize: '1rem', lineHeight: '1.6' }}>
//                 All legitimate job opportunities with xxx are posted <a href="#" onClick={handleDeadClick} className="text-gold-link">here on our official website</a>. If you encounter or suspect a fraudulent job posting or recruiter claiming to represent GT, please report it to us immediately at <a href="mailto:hr@nrlslaw.com" className="text-gold-link">hr@nrlslaw.com</a>.
//               </p>
//               <button 
...
//         /* Sidebar Separator Line (Desktop Only) */
...
//         .btn-submit {
//             background-color: #fdfdfd; /* Often light or gold in GT style */
//             color: #000;
...
//         /* Links */
//         .text-gold-link {
//             color: #bfa15f; /* Darker Gold for text */
...
//             border: 1px solid #999; /* Full border for textarea */
