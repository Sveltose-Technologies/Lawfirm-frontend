...
//     { 
//       id: 'LW-8821', type: 'Civil', title: 'Property Dispute', attorney: 'Adv. Tasnia Sharin', 
//       stage: 'Evidence', firstParty: 'John Doe', oppositeParty: 'Jane Smith', 
...
//     type: 'Civil', id: '', firstParty: '', oppositeParty: '', state: '', city: '', court: '', stage: 'Filed'
//   });
...
//     e.preventDefault();
//     const newCase = { ...formData, id: `LW-${Math.floor(1000 + Math.random() * 9000)}`, status: 'Running' };
...
//     "Documents - KYC", "Notes", "Opposing Party & Counsel", 
//     "Team Members", "Evidence Checklist"
//   ];

//   return (
//     <ClientLayout>
//       <Head><title>Case Details | Lawstick</title></Head>
...
//               <button className="btn btn-navy rounded-pill px-4 fw-bold" onClick={() => setShowModal(true)}>
...
//                   <select className="form-select select-custom"><option>Select Number</option></select>
//                 </div>
//                 <div className="col-12 col-md-3">
//                   <label className="label-custom">Practice Area</label>
//                   <select className="form-select select-custom"><option>Select Area</option></select>
//                 </div>
//                 <div className="col-12 col-md-3">
//                   <label className="label-custom">Attorney Name</label>
//                   <select className="form-select select-custom"><option>Select Attorney</option></select>
//                 </div>
//                 <div className="col-12 col-md-3">
//                   <label className="label-custom">Case Stage</label>
//                   <select className="form-select select-custom"><option>Select Stage</option></select>
//                 </div>
//               </div>
//             </div>
...
//               <button className="btn btn-light rounded-circle me-3 border shadow-sm" onClick={() => setView('list')}>
//                 <i className="bi bi-arrow-left"></i>
//               </button>
//               <h4 className="fw-bold m-0" style={{ color: '#002147', fontSize: '22px' }}>Case Overview</h4>
//             </div>
...
//                       <label className="text-muted fw-bold d-block small mb-1">{info.l}</label>
//                       <h6 className="fw-bold text-navy mb-0" style={{fontSize: '15px'}}>{info.v}</h6>
//                     </div>
//                   ))}
//                 </div>
//               )}
...
//                     {['Filed', 'Admitted', 'Evidence', 'Arguments', 'Order'].map((s, i) => (
//                       <div key={i} className="text-center position-relative z-1">
//                         <div className={`circle-step mx-auto mb-2 ${i <= 2 ? 'active' : ''}`}>
...
//               <h5 className="mb-0 fw-bold" style={{fontSize: '18px'}}>Create New Case</h5>
//               <button className="btn-close btn-close-white" onClick={() => setShowModal(false)}></button>
//             </div>
//             <form onSubmit={handleCreateCase} className="p-4 bg-white overflow-auto" style={{maxHeight: '75vh'}}>
//               <div className="row g-3">
//                 <div className="col-md-6"><label className="label-custom">Case Type</label><select className="form-select" name="type" onChange={(e)=>setFormData({...formData, type: e.target.value})}><option>Civil</option><option>Criminal</option></select></div>
//                 <div className="col-md-6"><label className="label-custom">First Party Name</label><input type="text" className="form-control" onChange={(e)=>setFormData({...formData, firstParty: e.target.value})} required /></div>
//                 <div className="col-md-6"><label className="label-custom">Opposite Party Name</label><input type="text" className="form-control" onChange={(e)=>setFormData({...formData, oppositeParty: e.target.value})} required /></div>
//                 <div className="col-md-6"><label className="label-custom">State Name</label><input type="text" className="form-control" onChange={(e)=>setFormData({...formData, state: e.target.value})} required /></div>
//                 <div className="col-md-6"><label className="label-custom">City Name</label><input type="text" className="form-control" onChange={(e)=>setFormData({...formData, city: e.target.value})} required /></div>
//                 <div className="col-md-6"><label className="label-custom">Court Number</label><input type="text" className="form-control" onChange={(e)=>setFormData({...formData, court: e.target.value})} required /></div>
//               </div>
//               <div className="mt-4 d-flex gap-2">
//                 <button type="submit" className="btn btn-navy w-100 fw-bold py-2">Save Case Record</button>
//                 <button type="button" className="btn btn-light border w-100" onClick={() => setShowModal(false)}>Cancel</button>
//               </div>
//             </form>
//           </div>
//         </div>
...
//         .btn-navy { background: #002147; color: white; border: none; font-size: 15px; }
//         .btn-gold { background: #de9f57; color: white; border: none; }
