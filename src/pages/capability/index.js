...
// //   useEffect(() => {
// //      console.error("Fetch Error:", fetchExpertiseData );
// //     const fetchExpertiseData = async () => {
// //       try {
// //         setLoading(true);
// //         const [catRes, subRes] = await Promise.all([
...
// //           // Mapping: ID compare nahi kar rahe, bas data structure bana rahe hain
// //           const formattedData = categories.map(cat => ({
// //             ...cat, // Saari IDs data mein rahegi
// //             category: cat.categoryName,
// //             items: subCategories // Bina filter kiye saari sub-categories dikhayenge
// //           }));
// //           setAllCapabilities(formattedData);
// //         }
// //       } catch (error) {
...
// //       <div style={{ position: 'relative', height: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundImage: 'url(/assets/images/our-firm4.png)', backgroundSize: 'cover' }}>
// //         <div style={{ position: 'absolute', inset: 0, backgroundColor: 'rgba(255, 255, 255, 0.4)' }}></div>
// //         <h1 style={{ position: 'relative', fontSize: '3.5rem', fontWeight: 'bold', fontFamily: 'Georgia' }}>Capabilities</h1>
// //       </div>

// //       <div style={{ backgroundColor: '#cfa144', padding: '20px', position: 'sticky', top: 0, zIndex: 100 }}>
...
// //         <h4 style={{ fontFamily: 'Georgia', borderBottom: '1px solid #ddd', paddingBottom: '15px', marginBottom: '40px' }}>Expertise A-Z</h4>
// //         <div className="row">
...
// //                     </Link>
// //                     <ul style={{ listStyle: 'none', paddingLeft: '15px', marginTop: '10px', borderLeft: '2px solid #eee' }}>
// //                       {item.items.map((sub, i) => (
// //                         <li key={i}><Link href={`/capability/${createSlug(sub.subcategoryName)}`}><a style={{ textDecoration: 'none', color: '#666', fontSize: '0.9rem' }}>{sub.subcategoryName}</a></Link></li>
// //                       ))}
// //                     </ul>
// //                   </div>
// //                 ))}
