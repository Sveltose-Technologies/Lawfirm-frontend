...
export default function AttorneyDashboard() {
  ...
  return (
    <AttorneyLayout>
      ...
      <div className="mb-5 pt-5">
        <h1 className="fw-bold display-5" style={{color: '#002147'}}>
          Good Morning, <span style={{ fontWeight: 500, fontSize: "1.2rem" }}>Tasnia Sharin</span>
        </h1>
        <p className="text-muted fs-5">Here's a quick overview of your performance.</p>
      </div>

      <div className="card border-0 shadow-sm rounded-4 p-4 p-md-5 bg-white">
        <h2 className="fw-bold mb-5" style={{fontFamily:'serif', color: '#002147'}}>Dashboard</h2>

        {/* Stats Cards */}
        <div className="row g-4 mb-5">
          <div className="col-md-4" onClick={() => setShowSuccessList(!showSuccessList)} style={{cursor: 'pointer'}}>
              <div className="card h-100 border shadow-sm rounded-4 p-4 text-center bg-white">
                  <div className="mb-3 mx-auto" style={{width: '70px', height: '70px', borderRadius: '50%', background: '#e8f7f0', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                     <i className="bi bi-hammer fs-3 text-success"></i>
                  </div>
                  <p className="mb-1 fw-bold text-muted fs-6">Success Cases</p>
                  <h1 className="fw-bold mb-0 display-5" style={{color: '#002147'}}>0</h1>
              </div>
          </div>
          {/* Appointment Card */}
          <div className="col-md-4">
              <div className="card h-100 border shadow-sm rounded-4 p-4 text-center bg-white">
                  <div className="mb-3 mx-auto" style={{width: '70px', height: '70px', borderRadius: '50%', background: '#fff8e6', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                     <i className="bi bi-hammer fs-3 text-warning"></i>
                  </div>
                  <p className="mb-1 fw-bold text-muted fs-6">Total Appointments</p>
                  <h1 className="fw-bold mb-0 display-5" style={{color: '#002147'}}>36</h1>
              </div>
          </div>
          {/* Total Case Card */}
          <div className="col-md-4">
              <div className="card h-100 border shadow-sm rounded-4 p-4 text-center bg-white">
                  <div className="mb-3 mx-auto" style={{width: '70px', height: '70px', borderRadius: '50%', background: '#eef4ff', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                     <i className="bi bi-hammer fs-3 text-primary"></i>
                  </div>
                  <p className="mb-1 fw-bold text-muted fs-6">Total Cases</p>
                  <h1 className="fw-bold mb-0 display-5" style={{color: '#002147'}}>9</h1>
              </div>
          </div>
        </div>

        {/* Aapka Gauge Chart aur baki content wahi rahega... */}
        <div className="row g-4 mb-5">
           <div className="col-md-6 border rounded-4 p-4 text-center">
              <h5 className="fw-bold text-start mb-4" style={{color: '#002147'}}>Case Overview</h5>
           ...
           <div className="col-md-6 border rounded-4 p-4 text-center">
              <h5 className="fw-bold text-start mb-4" style={{color: '#002147'}}>Upcoming Appointment</h5>
              <i className="bi bi-file-earmark-text display-1 text-light"></i>
              <p className="text-muted mt-3">No Upcoming Appointment</p>
           </div>
        </div>
      </div>
    </AttorneyLayout>
