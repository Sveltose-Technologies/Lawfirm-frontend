...
//     } else {
//       // Create logic (Descending - Naya upar)
//       const newTicket = {
...
//               <p className="text-muted mb-0" style={{fontSize: '15px'}}>Create support tickets and track your ticket history.</p>
//             </div>
//             <button 
...
//                     <td>{t.reason}</td>
//                     <td>
//                       <span className={`badge px-2 fw-normal border ${t.priority === 'High' ? 'text-danger border-danger' : t.priority === 'Medium' ? 'text-warning border-warning' : 'text-info border-info'}`}>
//                         {t.priority}
//                       </span>
//                     </td>
//                     <td>
//                       <span className={`badge px-3 rounded-pill ${t.status === 'Open' ? 'bg-primary-subtle text-primary' : 'bg-success-subtle text-success'}`}>
//                         {t.status}
//                       </span>
//                     </td>
//                     <td><small className="text-muted">{t.description.substring(0, 30)}...</small></td>
//                     <td className="text-center">
//                       <button className="btn btn-sm btn-outline-primary me-2 border-0" onClick={() => openEdit(t)} title="Edit">
//                         <i className="bi bi-pencil-square fs-6"></i>
//                       </button>
//                       <button className="btn btn-sm btn-outline-danger border-0" onClick={() => handleDelete(t.id)} title="Delete">
...
//                     <label className="form-label fw-bold small">Ticket Title</label>
//                     <input type="text" name="title" className="form-control" placeholder="Short summary" value={formData.title} onChange={handleChange} required />
//                   </div>
//                   <div className="col-md-6">
//                     <label className="form-label fw-bold small">Reason</label>
//                     <input type="text" name="reason" className="form-control" placeholder="Technical, General, Billing..." value={formData.reason} onChange={handleChange} required />
//                   </div>
//                   <div className="col-md-6">
...
//                     <textarea name="description" className="form-control" rows="4" placeholder="Explain your issue in detail..." value={formData.description} onChange={handleChange} required></textarea>
//                   </div>
//                 </div>
...
//         }
//         .modal-card { width: 100%; max-width: 650px; background: white; border-radius: 15px; overflow: hidden; animation: zoomIn 0.3s ease; }
