    ...
    <>
      ...
      <div className="container py-5">
        ...
        {countries.map(country => {
          ...
          return (
            <div key={country.id} className="mb-3 border rounded overflow-hidden">
              <div
              ...
              {isOpen && (
                <div className="p-4 bg-white">
                  <div className="row g-4">
                    {countryCities.map(city => (
                      <div key={city.id} className="col-md-4">
                        <Link href={`/location/${city.id}`} passHref>
                          <a className="card h-100 shadow-sm text-decoration-none location-card">
                            <div className="img-container">
                                <img
                                src={`${authService.IMG_URL}/${city.image}`}
                                className="card-img-top"
                                alt={city.cityName}
                                />
                            </div>
      ...
      <style jsx>{`
        .location-banner {
          min-height: 400px;
          background: url('/assets/images/banner-img3.png') center/cover no-repeat;
          position: relative;
        }
        ...
        .location-card { transition: 0.3s; border: none; }
